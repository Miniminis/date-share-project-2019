...
public class DeleteActivityService2 {
	// 싱글톤
	private DeleteActivityService2() {}
	private static DeleteActivityService2 serviceD = new DeleteActivityService2();
	public static DeleteActivityService2 getInstance() {
		return serviceD;
	}
